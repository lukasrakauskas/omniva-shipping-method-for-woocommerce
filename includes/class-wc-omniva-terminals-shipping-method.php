...
class WC_Omniva_Terminals_Shipping_Method extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'omniva_terminals';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __( 'Omniva parcel terminals', 'omniva-shipping-method-for-woocommerce' );
		$this->method_description = __( 'Shipping to "Omniva" self-service parcel terminals', 'omniva-shipping-method-for-woocommerce' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
	...
	public function init_form_fields() {
		$this->instance_form_fields = array(
			'title' => array(
				'title'         => __( 'Title', 'omniva-shipping-method-for-woocommerce' ),
				'type'          => 'text',
				'description'   => __( 'Title to be display on site', 'omniva-shipping-method-for-woocommerce' ),
				'default'       => __( 'Omniva parcel terminals', 'omniva-shipping-method-for-woocommerce' ),
				'desc_tip'      => true,
			),

			'cost' => array(
				'title'         => __( 'Cost', 'omniva-shipping-method-for-woocommerce' ),
				'type'          => 'number',
				'description'   => __( 'Shipping price', 'omniva-shipping-method-for-woocommerce' ),
				'placeholder'   => '0',
				'default'       => 0,
				'desc_tip'      => true,
			),
			...
			'free_shipping'     => array(
				'title'         => __( 'Free shipping', 'omniva-shipping-method-for-woocommerce' ),
				'type'          => 'number',
				'description'   => __( 'Free shipping if price greater than (0 - turned off)', 'omniva-shipping-method-for-woocommerce' ),
				'placeholder'   => '0',
				'default'       => 0,
				'desc_tip'      => true,
			),
			...
			'tax_status' => array(
				'title'         => __( 'Tax status', 'omniva-shipping-method-for-woocommerce' ),
				'type'          => 'select',
				'class'         => 'wc-enhanced-select',
				'default'       => 'none',
				'options'       => array(
					'taxable'   => __( 'Taxable', 'omniva-shipping-method-for-woocommerce' ),
					'none'      => _x( 'None', 'Tax status', 'omniva-shipping-method-for-woocommerce' ),
				),
			),
	...
	public function get_terminals( ) {
		...
		$terminals_json  = array_filter( $terminals_json, function($location) {
			return ($location->A0_NAME == "LT");
		} );

		$locations       = array();
		
		foreach( $terminals_json as $key => $location ) {
			$locations[$location->A1_NAME][] = (object) array(
				'place_id'   => $location->NAME,
				'zipcode'    => $location->ZIP,
				'name'       => $location->NAME,
				'city'       => $location->A1_NAME,
				'address'    => $location->A2_NAME,
				'comment'    => $location->comment_lit
			);
		}
	...
	public function validate_user_selected_terminal( $posted ) {
		...
		$error = __( 'Please select a parcel terminal', 'omniva-shipping-method-for-woocommerce' );
